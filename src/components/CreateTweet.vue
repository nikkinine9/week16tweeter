<template>
  <div>
    <div id="newsfeed-container">
      ...
      <textarea type="text" id="tweet-post" v-model="tweetContent" placeholder="Max 200 characters"></textarea>
      <div></div>
      <button id="post-tweet-btn" @click="postTweet">Post Chirp</button>
      <h4>{{ tweetStatus }}</h4>
      <br>
    </div>
  </div>
