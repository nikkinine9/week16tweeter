<template>
  <div id="follow-unfollow-btn">
    <img v-if="isFollowing == false" src="../assets/follow.png" alt="Follow Icon" id="tweet-btn-unfollow" @click="followUser">
    <img v-else-if="isFollowing == true" src="../assets/unfollow.png" alt="Unfollow Icon" id="tweet-btn-follow" @click="unfollowUser">
    <span></span>
  </div>
</template>
