<template>
  <div>
    <div id="likes-container">
      <img id="like" @click="likeComment(commentId)" v-if="isLiked == false" src="../assets/like-comment.png" alt="Heart Icon">
      <img id="unlike" @click="unlikeComment" v-else-if="isLiked == true" src="../assets/unlike.png" alt="Thumbs Down Icon">
      <span></span>
